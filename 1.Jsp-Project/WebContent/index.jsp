...
<nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
  ...
  <div class="collapse navbar-collapse" id="navbarsExampleDefault">
    ...
    <form class="form-inline my-2 my-lg-0">
      <button type="button" class="btn btn-outline-success my-2 my-sm-0" onclick="javascript:window.location.href='./member/join.jsp'">회원가입</button>
    </form>
  </div>
</nav>
...
<footer class="container">
  <a href="./admin/adminlogin.jsp"><p>© ChangHwan </p></a>
</footer>

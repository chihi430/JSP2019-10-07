...
<div class="container">
		  ...
		  <div class="row">
		    <div class="col-md-12 order-md-10">
		      ...
		      <form class="needs-validation" novalidate="" action ="../modifyOk.to" method="post">
		      
		        <div class="row">
		          <div class="col-md-12 mb-3">
		            <label for="firstName">Your ID</label>
		            <input style="width:300px;" type="text" class="form-control" id="firstName" name="id" placeholder="아이디" value="<%= dto.getId() %>" required="" readonly>
		          </div>
		        </div>
		        ...
		        <div class="mb-3">
		          <label for="username">Username</label>
		            ...
		            <input style="width:300px;" type="text" class="form-control" id="username" name="name" placeholder="이름" required="" value="<%= dto.getName() %>" readonly>
		            <div class="invalid-feedback">
		             	이름 입력은 필수 입니다!
		            </div>
		        ...
		        <div class="mb-3">
		          ...
		          <input type="text" class="form-control" id="address" name="address" placeholder="주소" required="" value="<%= dto.getAddress() %>">
		          <div class="invalid-feedback">
		             	주소를 입력해 주세요!
		          </div>
		        </div>
		        ...
		        <hr class="mb-4">
		        <div align ="center">			
		        <button style="width:300px;" class="btn btn-primary btn-lg btn-block" onclick="updateInfoConfirm()">정보 수정</button>

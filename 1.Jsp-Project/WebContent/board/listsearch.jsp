...
<div class="container">
	<table class="table table-hover" width="600" cellpadding="0" cellspacing="0" border="1" >
		...
		<tr>
			...
			<form class="form-inline my-3 my-lg-0" action="search.do" method="post">
		  ...
		  <ul class="pagination justify-content-center">
		    ...
		    <li class="page-item">
				...
				<c:choose>
					...
					<c:otherwise>
						<li class="page-item">
						<a class="page-link" href ="search.do?page=${page.curPage + 1}&search=<%= session.getAttribute("csearch") %>&option=<%= session.getAttribute("cmenuchoice") %>"  tabindex="-1" aria-disabled="true">Next</a>
					</c:otherwise>
				</c:choose>
		    </li>		    
